...
situation_dict = {
    "6D pre-shock": {
        ...
        "intr": 0.00,
        "texp": 6.0/365.25,
        "strike": np.array([85.0, 98.0, 100.0, 102.0, 115.0]),
        "spot": 100.0,
        "p_exact": np.array([15.069, 3.7425, 2.6023, 1.717, 0.0474]),
        "description": "6D pre-shock ITM ATM OTM",
    },
    "6D during crash":{
        "sigma": 0.554,
        "vov": 20.0,
        ...
        "strike": np.array([85.0, 98.0, 100.0, 102.0, 115.0]),
        "spot": 100.0,
        "p_exact": np.array([15.0718, 3.9022, 2.792, 1.9203, 0.092]),
        "description": "6D during crash ITM ATM OTM",
    },
    "6D recovery":{
        "sigma": 0.471,
        "vov": 17.14,
        ...
        "strike": np.array([85.0, 98.0, 100.0, 102.0, 115.0]),
        "spot": 100.0,
        "p_exact": np.array([15.0794, 3.9011, 2.7761, 1.8889, 0.0671]),
        "description": "6D recovery ITM ATM OTM",
    },
    "20D pre-shock":{
        "sigma": 0.40,
        "vov": 13.26,
        ...
        "strike": np.array([85.0, 98.0, 100.0, 102.0, 115.0]),
        "spot": 100.0,
        "p_exact": np.array([15.3814, 5.2449, 4.1746, 3.2612, 0.4313]),
        "description": "20D pre-shock ITM ATM OTM",
    },
    "20D during crash":{
        "sigma": 0.487,
        "vov": 17.6,
        ...
        "strike": np.array([85.0, 98.0, 100.0, 102.0, 115.0]),
        "spot": 100.0,
        "p_exact": np.array([15.3463, 5.0572, 3.9742, 3.0576, 0.3537]),
        "description": "20D during crash ITM ATM OTM",
    },
    "20D recovery":{
        "sigma": 0.422,
        "vov": 11.97,
        ...
        "strike": np.array([85.0, 98.0, 100.0, 102.0, 115.0]),
        "spot": 100.0,
        "p_exact": np.array([15.4037, 5.3777, 4.32, 3.4135, 0.5129]),
        "description": "20D recovery ITM ATM OTM",
    },
}
